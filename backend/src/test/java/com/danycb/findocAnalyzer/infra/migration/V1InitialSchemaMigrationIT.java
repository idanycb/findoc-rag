...
class V1InitialSchemaMigrationIT {
    ...
    @Test
    void freshSchemaIsCreatedByOneMigrationWithEdgarAmendmentSupport() throws Exception {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            assertThat(names)
                    .containsExactlyInAnyOrder(
                            ...
                            "document_metadata.analysis_publication_claimed",
