...
export default function LoginPage() {
  return (
    <div className="min-h-screen bg-[#EBEBEB] flex items-center justify-center px-6 py-12">
      <div className="w-full max-w-225 overflow-hidden rounded-[20px] bg-white shadow-[0_2px_24px_rgba(0,0,0,.08)] md:flex">
        <div className="bg-[#111111] px-7 py-9 md:w-105 md:flex-none md:p-12 md:flex md:flex-col md:justify-between">
          <div>
            <div className="flex items-center gap-2.75">
              <div className="flex h-9.5 w-9.5 items-center justify-center rounded-[11px] bg-white">
            ...
            <h2 className="mt-10 text-[28px] font-bold leading-tight tracking-[-.02em] text-white md:block hidden">
              Financial documents,
              <br />
              analyzed and
              <br />
            ...
            <p className="mt-1.5 text-sm text-[#888888] md:hidden">
              Access your team&apos;s document vault.
            </p>
            <p className="mt-4.5 hidden max-w-75 text-sm leading-[1.65] text-[#888888] md:block">
              Upload PDFs and documents. Get grounded answers through RAG-powered chat.
            </p>
          </div>
          <div className="mt-8 hidden flex-wrap gap-2 md:flex">
            <span className="rounded-md border border-[#333333] bg-[#1E1E1E] px-2.75 py-1.25 text-[11px] font-semibold tracking-[.04em] text-[#555555]">
              RAG grounded
            </span>
            <span className="rounded-md border border-[#333333] bg-[#1E1E1E] px-2.75 py-1.25 text-[11px] font-semibold tracking-[.04em] text-[#555555]">
              Team-scoped vault
